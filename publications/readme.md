...
| [*Wie der Krieg sich auf Glück und Lebenszufriedenheit in der Ukraine auswirkt* (2025)](https://laender-analysen.de/ukraine-analysen/319/ukraine-krieg-glueck-lebenszufriedenheit/) | `Glück und Lebenszufriedenheit in der Ukraine.R` | Code for replicating the data analysis presented in the material using panel survey data from both Waves 1 & 2. Includes data preparation (construction of war exposure index, identifying age groups), performing statistical tests for group comparison and regression analysis, as well as the script for Figures 1-2. |
| [*No atheists in wartime?* (2023)](https://voxukraine.org/en/no-atheists-in-wartime) | `No atheists in wartime.R` | Code for replicating the data analysis presented in the material using panel survey data from both Waves 1 & 2. Includes data preparation (construction of Religious Involvement Index, recoding variables), computation of percentages and means, performing statistical tests for group comparison, and the script for figures. |
| [*Perspective(s) of R. Inglehart's Theory of Evolutionary Modernization: Analysis of Change in Religiosity in Ukraine during the War* (2024)](https://stmm.in.ua/archive/ukr/2024-1/8.pdf) | `Inglehart_religiosity_analysis.R` | Code for replicating the data analysis presented in the article using panel survey data from both Waves 1 & 2. Includes data preparation (grouping oblasts by regions, recoding variables), computation of means and Spearman correlations, performing statistical tests for group comparison and regression analysis, as well as the script for figures. |
