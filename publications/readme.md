...
| [*Perspective(s) of R. Inglehart's Theory of Evolutionary Modernization: Analysis of Change in Religiosity in Ukraine during the War* (2024)](https://stmm.in.ua/archive/ukr/2024-1/8.pdf) | `Inglehart_religiosity_analysis.R` | Code for replicating the data analysis presented in the article using panel survey data from both Waves 1 & 2. Includes data preparation (grouping oblasts by regions, recoding variables), computation of means, performing statistical tests for group comparison and regression analysis, as well as the script for figures. |
